...
public class Ejercicio01 {
	...
	private static final String SQL_INFORME = """
			...
			ORDER BY title;
			""";
	private static final Path PATH_FICHERO = Path.of("datos", "informeEj01.txt");
	...
	public static void main(String[] args) {
		...
		try (Connection conexion = DriverManager.getConnection(CONNECTION_URL, USERNAME, PASSWORD);
			...
			String formatString = "| %-50.50s | %-20.20s | %-50.50s | %-10.10s | %-10.10s |\n";
			...
			pw.printf(formatString, "Cliente", "Teléfono", "Película", "Alquilada", "Devolver");
			pw.println("-".repeat(longitud));
