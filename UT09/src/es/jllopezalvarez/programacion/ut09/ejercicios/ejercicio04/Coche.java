...
public class Coche {
	 ...
	 */
	public Coche(String matricula, boolean arrancado, boolean circulaHaciaAtras, int vMax, int vMaxAtras,
			int velocidad) {
		if (vMax <= 0) {
	 ...
	 */
	public Coche(String matricula, int vMax, int vMaxAtras) throws IllegalArgumentException {
		this(matricula, false, false, vMax, vMaxAtras, 0);
	}
	...
	public String toString() {
		return String.format("Coche [matricula=%s, arrancado=%s, circulaHaciaAtras=%s, velocidad=%s]", matricula,
				arrancado, circulaHaciaAtras, velocidad);
	}
