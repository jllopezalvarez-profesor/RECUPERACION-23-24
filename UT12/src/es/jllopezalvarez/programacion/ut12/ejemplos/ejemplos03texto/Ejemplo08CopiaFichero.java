...
/**
 * 
 * Copiar un fichero en bloques de bytes usando streams (Reader y Writer) de Java.
 *
 */
public class Ejemplo08CopiaFichero {
	...
	public static void main(String[] args) throws IOException {
		...
		try (Reader in = new FileReader(NOMBRE_FICHERO_ENTRADA); Writer out = new FileWriter(NOMBRE_FICHERO_SALIDA)) {
