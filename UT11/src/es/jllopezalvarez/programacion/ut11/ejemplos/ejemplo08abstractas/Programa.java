...
import es.jllopezalvarez.programacion.ut11.ejemplos.ejemplo08abstractas.electrodomesticos.*;
...
public class Programa {
	...
	public static void main(String[] args) {
		...
		electrodomesticos[8] = new PlanchaVapor(300, Color.AZUL, ConsumoEnergetico.C, 90);
		electrodomesticos[9] = new PlanchaVapor();
	...
	private static void mostrarTodos(Electrodomestico[] electrodomesticos) {
		...
		for (int i = 0; i < electrodomesticos.length; i++) {
			if (electrodomesticos[i] != null) {
				System.out.printf("Precio final del electrodoméstico (%s) en la posición %d: %.2f\n",
						electrodomesticos[i].getTipoElectrodomestico(), i, electrodomesticos[i].getPrecioFinal());
